        ...
        <div class="col-sm-6">
            <fieldset>
                ...
                <p style="font-size:15px; margin-bottom:0px;">
                    ...
                    <span style="color:#282727;">Start Date</span> : {{\Carbon\Carbon::parse($job_details->start_date_of_care)->format('m-d-Y')}} &nbsp;-&nbsp; End Date</span> : {{\Carbon\Carbon::parse($job_details->end_date_of_care)->format('m-d-Y')}} <br>
